export const TRIP_INFO = {
  title: "Kansai Trip App 2026 - Project 2",
  traveler: "Awirut Som",
...
export const DAYS = [
  {
    ...
    city: "Osaka",
    pass: false,
    theme: "Arrival day + Minoo + Umeda + Shinsekai",
    color: "#b8342f",
    activities: [
  ...
  },
  {
    ...
    city: "Himeji / Kobe",
    pass: true,
    theme: "เปิด pass + Himeji + Kobe full day",
    color: "#3d6ec9",
    activities: [
  ...
  },
  {
    id: 3,
    date: "อาทิตย์ 22 พ.ย.",
    city: "Okayama / Kurashiki",
    pass: true,
    theme: "Okayama + Kurashiki day trip",
    color: "#259a61",
    activities: [
  ...
  },
  {
    ...
    city: "Kyoto",
    pass: true,
    theme: "Kyoto highlights from west to east",
    color: "#8a45b0",
    activities: [
  ...
  },
  {
    ...
    city: "Nara / Uji / Osaka",
    pass: true,
    theme: "Nara deer + Uji matcha + Osaka night",
    color: "#db7c21",
    activities: [
  ...
  },
  {
    ...
    city: "Kinosaki / KIX",
    pass: true,
    theme: "Long day trip + airport transfer",
    color: "#178d82",
    activities: [
...
export const BACKUP_REGIONS = [
  {
    region: "Osaka เติมวันเบาๆ",
    spots: [
  ...
  {
    region: "Pass day trip ideas",
    spots: [
      { id: "bk-kw-1", name: "Takamatsu + Ritsurin", cat: "ธรรมชาติ", cost: "¥410", time: "เต็มวัน", pass: "ใช้ pass ได้", desc: "ข้ามไปชิโกกุด้วย Marine Liner" },
      { id: "bk-kw-2", name: "Naoshima", cat: "ศิลปะ", cost: "เพิ่มเติม", time: "เต็มวัน", pass: "JR บางส่วน", desc: "เกาะศิลปะเหมาะกับคนอยากออกนอกเส้นทาง" },
      { id: "bk-kw-3", name: "Wakayama + Kishi Station", cat: "สนุก", cost: "ต่ำ", time: "ครึ่งวัน", pass: "ใช้ pass ได้", desc: "ปราสาท ปลา และแมวหัวหน้าสถานี" }
    ]
  },
  {
    region: "Kobe / Hyogo เพิ่มเติม",
    spots: [
      { id: "bk-kb-1", name: "Akashi Kaikyo Bridge", cat: "วิว", cost: "¥300+", time: "1-2 ชม.", pass: "JR ได้", desc: "สะพานแขวนที่ iconic มาก ถ้าอยากเพิ่มวิวทะเล" },
      { id: "bk-kb-2", name: "Nada Sake District", cat: "กินดื่ม", cost: "ฟรี", time: "2 ชม.", pass: "JR ได้", desc: "เหมาะกับคนชอบ sake และ museum เล็กๆ" }
    ]
  }
];
...
export const DEFAULT_CHECKLIST = [
  ...
  { id: "cl-doc-2", cat: "Documents", text: "เซฟ confirmation โรงแรมและที่อยู่เป็นภาษาญี่ปุ่น" },
  { id: "cl-money-1", cat: "Money", text: "แลกเงินเยนและเช็กบัตรที่ใช้ต่างประเทศได้" },
  { id: "cl-bag-1", cat: "Packing", text: "เตรียมเสื้อกันหนาว รองเท้าเดินสบาย และร่มพับ" },
  { id: "cl-bag-2", cat: "Packing", text: "เตรียม power bank, daypack, ยาส่วนตัว และปลั๊ก" },
  { id: "cl-app-1", cat: "Apps", text: "ติดตั้ง Navitime, Tabelog, และแอปที่ใช้นำทาง" }
];

export const JAPANESE_SCRIPTS = [
  {
    cat: "สนามบิน / JR",
    items: [
      {
        title: "แลก JR Pass",
        jp: "JRパスの引き換えをお願いします。これが引換証です。",
        reading: "เจอาร์พาสึ โนะ ฮิคิคาเอะ โอ เนไกชิมัส",
        th: "ขอแลก JR Pass ครับ นี่คือ voucher"
      },
      {
        title: "ซื้อ ICOCA",
        jp: "ICOCAカードを1枚ください。",
        reading: "ICOCA kaado wo ichimai kudasai",
        th: "ขอ ICOCA card 1 ใบครับ"
      }
    ]
  },
  {
    ...
    items: [
      {
        title: "Check-in",
        jp: "チェックインをお願いします。予約しています。",
        reading: "Check-in wo onegaishimasu. Yoyaku shiteimasu.",
        th: "ขอ check-in ครับ ผมจองไว้แล้ว"
      },
      {
        title: "ฝากกระเป๋า",
        jp: "荷物を預かっていただけますか？",
        reading: "Nimotsu wo azukatte itadakemasu ka?",
        th: "ฝากกระเป๋าไว้ก่อนได้ไหมครับ"
      }
    ]
  },
  {
    cat: "ร้านอาหาร / ฉุกเฉิน",
    items: [
      {
        title: "ขอโต๊ะ",
        jp: "2人です。席はありますか？",
        reading: "Futari desu. Seki wa arimasu ka?",
        th: "มา 2 คนครับ มีโต๊ะไหม"
      },
      {
        title: "ไม่เข้าใจภาษาญี่ปุ่น",
        jp: "すみません、日本語がわかりません。英語はできますか？",
        reading: "Sumimasen, nihongo ga wakarimasen. Eigo wa dekimasu ka?",
        th: "ขอโทษครับ ผมไม่เข้าใจญี่ปุ่น พูดอังกฤษได้ไหม"
      }
    ]
  }
];

export const DEFAULT_BUDGET_PLAN = {
  1: 8000,
  2: 9000,
  3: 10000,
  4: 7000,
